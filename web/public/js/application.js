...
//# sourceMappingURL=manager.map
  ...
  ScheduleList = (function(_super) {
    ...
    ScheduleList.prototype.addOne = function(it) {
      ...
      return this.append(view.render());
    };
  ...
  ScheduleItem = (function(_super) {
    ...
    ScheduleItem.prototype.show = function() {};

    ScheduleItem.prototype.showcyc = function() {
      return alert('！');
    };

    ScheduleItem.prototype.mouseover = function() {
      this.panel.css("box-shadow", "0 0 22px #777");
      return this.jobcnt.css("background-color", "#d9edf7");
    };

    ScheduleItem.prototype.mouseout = function() {
      this.panel.css("box-shadow", "");
      return this.jobcnt.css("background-color", "");
    };
  ...
  var App, Main, Manager, ScheduleList, Spine,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  App = (function(_super) {
    ...
    function App() {
      ...
      main = new Main;
      this.append(main.schedules.active());
      Spine.Route.setup();
    }
  ...
  Schedule = (function(_super) {
    ...
    Schedule.prototype.GetSecond = function() {
      ...
      for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
        ...
        switch (false) {
          case !(t < 60):
            _results.push("" + (this.addStartPrefix('ss')) + t + "秒");
            break;
          case !((60 <= t && t < 60 * 60)):
            _results.push("" + (this.addStartPrefix('mi')) + (this.getMinuets(t)));
            break;
          case !((60 * 60 <= t && t < 60 * 60 * 24)):
            _results.push("" + (this.addStartPrefix('h')) + (this.getHour(t)));
            break;
          case !((60 * 60 * 24 <= t && t < 60 * 60 * 24 * 31)):
            if (this.StartMonth[i] > 0) {
              _results.push("" + (this.addStartPrefix('m')) + (this.StartMonth[i] + 1) + "月" + (this.getDay(t)));
            } else {
              _results.push("" + (this.addStartPrefix('d')) + (this.getDay(t)));
            }
            break;
          default:
            _results.push("未知");
    ...
    Schedule.prototype.addStartPrefix = function(cyc) {
      switch (cyc) {
        case "ss":
          switch (this.Cyc) {
            case "h":
    ...
    Schedule.prototype.getMinuets = function(tm) {
      if ((tm % 60) > 0) {
        return "" + (Math.floor(tm / 60)) + "分" + (tm % 60) + "秒";
      } else {
        return "" + (tm / 60) + "分";
      }
    };

    Schedule.prototype.getHour = function(tm) {
      if (tm % (60 * 60) > 0) {
        return "" + (Math.floor(tm / (60 * 60))) + "点" + (this.getMinuets(tm % (60 * 60)));
      } else {
        return "" + (tm / 60 / 60) + "点";
      }
    };

    Schedule.prototype.getDay = function(tm) {
      if (tm % (60 * 60 * 24) > 0) {
        return "" + (Math.floor(tm / (60 * 60 * 24))) + "日" + (this.getHour(tm % (60 * 60 * 24)));
      } else {
        return "" + (tm / 60 / 60 / 24) + "日";
      }
    };
...
}, "views/schedule.show": function(exports, require, module) {var content = function(__obj) {
  if (!__obj) __obj = {};
  ...
  (function() {
    (function() {
      __out.push('<div class="panel panel-default">\n    <div class="panel-heading">\n        <!-- 标题 -->\n        <div class="panel-title title">\n            <span class="h4">');
    
      __out.push(__sanitize(this.Name));
    
      __out.push('</span>\n            <!-- 周期 -->\n            <span class="pull-right label ');
    
      __out.push(__sanitize(this.GetCycStyle()));
    
      __out.push(' cyc">');
    
      __out.push(__sanitize(this.GetCyc()));
    
      __out.push('</span>\n        </div>\n    </div>\n        \n\t<div class="panel-body row container-fluid">\n        <div class="col-sm-12">\n            <!-- 下次启动时间 -->\n            <h5>');
    
      __out.push(__sanitize(this.GetSecond()));
    
      __out.push('&nbsp;<span class="caret"></span></h5>\n        </div>\n        <div id="jobcnt" class="col-sm-12" >\n            <h5>任务数：<span class="jobcnt badge">');
    
      __out.push(__sanitize(this.TaskCnt));
    
      __out.push('</span></h5>\n        </div>\n        <div class="col-sm-12 nextstart">\n            <h5>下次执行：');
    
      __out.push(__sanitize(this.GetNextStart()));
    
      __out.push('</h5>\n        </div>\n\n\t</div>\n\t<div class="panel-footer" style="padding: 5px 15px 24px;">\n      <div>\n            <!-- 执行次数-->\n            <span class="pull-right label label-default">\n               45\n               <span class="process glyphicon glyphicon-ok"></span>\n            </span>\n            <span class="pull-right label">\n            </span>\n            <span class="pull-right label label-warning">\n               4\n               <span class="process glyphicon glyphicon-remove"></span>\n            </span>\n      </div>\n\n\t</div>\n</div>\n');
