...
(function() {
  ...
  Model = (function(_super) {
    ...
    Model.all = function() {
      ...
      console.log('------------');
      console.log(this.cloneArray(this.records));
...
//# sourceMappingURL=manager.map
  ...
  Schedule = (function(_super) {
    ...
    Schedule.configure('Schedule', 'Id', 'Name', 'TaskCnt', 'Count', 'Cyc', 'StartMonth', 'StartSecond', 'NextStart', 'TimeOut', 'Desc', 'CreateTime', 'CreateUserId', 'ModifyTime', 'ModifyUserId');
