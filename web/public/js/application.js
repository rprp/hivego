...
module.exports = jQuery;}, "momentifycn/index": function(exports, require, module) {// moment.js
// version : 2.1.0
// author : Tim Wood
// license : MIT
// momentjs.com
...
}, "raphaelify/index": function(exports, require, module) {// ┌─────────────────────────────────────────────────────────────────────┐ \\
...
}, "raphaelify/node_modules/eve/eve": function(exports, require, module) {// Copyright (c) 2013 Adobe Systems Incorporated. All rights reserved.
// 
...
}, "raphaelify/raphael.svg": function(exports, require, module) {// ┌─────────────────────────────────────────────────────────────────────┐ \\
...
}, "raphaelify/raphael.vml": function(exports, require, module) {// ┌─────────────────────────────────────────────────────────────────────┐ \\
// │ Raphaël - JavaScript Vector Library                                 │ \\
// ├─────────────────────────────────────────────────────────────────────┤ \\
// │ VML Module                                                          │ \\
// ├─────────────────────────────────────────────────────────────────────┤ \\
...
}(window.Raphael);}, "eve": function(exports, require, module) {// Copyright (c) 2013 Adobe Systems Incorporated. All rights reserved.
// 
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
// You may obtain a copy of the License at
...
}, "spineify/index": function(exports, require, module) {module.exports = require('./lib/spineify');
}, "spineify/lib/spineify": function(exports, require, module) {// Generated by CoffeeScript 1.7.1
  ...
  Model = (function(_super) {
    ...
    function Model(atts) {
      ...
      if ((this.constructor.uuid != null) && typeof this.constructor.uuid === 'function') {
        ...
        this.cid = (atts != null ? atts.cid : void 0) || this.constructor.uid('');
      }
      if (atts) {
        this.load(atts);
      }
...
//# sourceMappingURL=spineify.map
}, "spineify/lib/local": function(exports, require, module) {// Generated by CoffeeScript 1.7.1
(function() {
  var Spine;

  Spine = this.Spine || require('spineify');
...
}, "spineify/lib/ajax": function(exports, require, module) {// Generated by CoffeeScript 1.7.1
(function() {
    ...
    Collection.prototype.fetch = function(params, options) {
      ...
      if (Id = params.Id) {
        ...
        return this.find(Id, params, options).done((function(_this) {
          return function(record) {
            _this.model.refresh(record, options);
            return _this.model.trigger('findRecord', record);
          };
        })(this));
      } else {
...
}, "spineify/lib/route": function(exports, require, module) {// Generated by CoffeeScript 1.7.1
(function() {
...
}, "spineify/lib/list": function(exports, require, module) {// Generated by CoffeeScript 1.7.1
(function() {
  var $, Spine,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
...
}, "spineify/lib/manager": function(exports, require, module) {// Generated by CoffeeScript 1.7.1
(function() {
  var $, Spine,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
...
//# sourceMappingURL=manager.map
  ...
  JobManager = (function(_super) {
    ...
    JobManager.prototype.refreshJobList = function(top, left, isRefresh) {
      ...
      for (i = _j = 0, _len1 = _ref1.length; _j < _len1; i = ++_j) {
        ...
        s.hover(this.hlightTasks = function() {
          var _ref2;
          return (_ref2 = this.data("sinfo")) != null ? _ref2.taskShape.hlight(this.data("Id")) : void 0;
        }, this.nlightTasks = function() {
          var _ref2;
          return (_ref2 = this.data("sinfo")) != null ? _ref2.taskShape.nlight(this.data("Id")) : void 0;
        });
        this.set.push(s);
        this.list.push(s);
        this.lastJob = job;
  ...
  var $, Eve, JobManager, MainInfo, Raphael, Schedule, ScheduleManager, Spine, Style, TaskManager, wheel,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  MainInfo = (function(_super) {
    __extends(MainInfo, _super);

    MainInfo.prototype.className = 'maininfo';

    MainInfo.prototype.elements = {
      ".pant": "pant"
    };
    ...
    function MainInfo() {
      ...
      this.render = __bind(this.render, this);
      this.change = __bind(this.change, this);
      MainInfo.__super__.constructor.apply(this, arguments);
      Schedule.bind("findRecord", this.draw);
      Spine.bind("addJobRender", (function(_this) {
        return function(x, y, job) {
          return _this.append(_this.jobManager.render(x, y, job));
        };
      })(this));
      Spine.bind("addTaskRender", this.addTaskRender = (function(_this) {
    ...
    MainInfo.prototype.render = function() {
      return this.html(require('views/main-info')());
    };

    MainInfo.prototype.draw = function(rs) {
      var h, slider, _ref, _ref1, _ref2;
      if (rs) {
    ...
    MainInfo.prototype.layout = function() {
  ...
  var $, MainList, Schedule, ScheduleItem, Spine,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  ScheduleItem = (function(_super) {
    ...
    ScheduleItem.prototype.className = 'scheduleitem col-sm-3';
    ...
    ScheduleItem.prototype.events = {
      ...
      "click .sname": function(e) {
        return this.navigate('/schedules', this.item.Id);
      },
      "click .pbmask": function(e) {
        return this.navigate('/schedules', this.item.Id);
      },
      "mouseenter": ScheduleItem.mouseover = function(e) {
      ...
      "mouseleave": ScheduleItem.mouseout = function(e) {
    ...
    ScheduleItem.prototype.render = function(item) {
      ...
      this.html(require('views/main-list')(this.item));
      return this;
    };
  ...
  MainList = (function(_super) {
    ...
    MainList.prototype.addOne = function(it) {
      var view;
  ...
  Navbar = (function(_super) {
    ...
    Navbar.prototype.events = {
      "mouseenter h1": function(e) {
        return $(e.target).stop().animate({
          backgroundColor: '#777'
        }, 400);
      },
      "mouseleave h1": function(e) {
        return $(e.target).stop().animate({
          backgroundColor: '#333'
        }, 200);
      },
      ...
      "click #refreshAll": function(e) {
        e = e || window.event;
        return this.trigger('refreshAllTask', e);
      },
      "click #home": function(e) {
        return this.navigate('/schedules');
      },
      "focus .sinput": function(e) {
        $(e.target).stop().animate({
          width: '300px'
        }, 400);
        return window.setTimeout((function(_this) {
          return function() {
            return _this.sinput.val("");
          };
        })(this), 1);
      },
      "blur .sinput": function(e) {
        $(e.target).stop().animate({
          width: '50px'
        }, 400);
        return this.sinput.val("");
      },
      "keypress": function(e) {
        var _ref;
        console.log(e.keyCode);
        e = e || window.event;
        if ((_ref = e.keyCode) === 27 || _ref === 13) {
          return this.sinput.blur();
        }
      }
    };
  ...
  Form = (function(_super) {
    ...
    Form.prototype.events = {
      ...
      "click .cyclbl": Form.setCyc = function(e) {
      ...
      "keypress .addSchedule": Form.keypress = function(e) {
        var _ref;
        e = e || window.event;
        if (e.ctrlKey && ((_ref = e.keyCode) === 13 || _ref === 10)) {
      ...
      "mouseenter .list-group-item": Form.showDelStart = function(e) {
        return $(e.target).children(".delStart").css("display", "");
      },
      "mouseleave .list-group-item": Form.hideDelStart = function(e) {
        return $(e.target).children(".delStart").css("display", "none");
      },
      "mousedown .addScheduleHead": Form.setMoveFlg = function(e) {
        this.isMove = true;
        this.preLeft = e.clientX;
        return this.preTop = e.clientY;
      },
      "mouseup .addScheduleHead": Form.clearMoveFlg = function(e) {
        this.isMove = false;
        return this.el.css("opacity", 1);
      },
      "mousemove .addScheduleHead": Form.movePanel = function(e) {
        var dx, dy;
        if (!this.isMove) {
          return;
        }
    ...
    Form.prototype.render = function(x, y, schedule) {
      ...
      window.setTimeout((function(_this) {
        return function() {
          return _this.scheduleName.focus();
        };
      })(this), 500);
      _ref = this.cycGroup;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
  ...
  Shape = (function(_super) {
    ...
    Shape.prototype.refreshSchedule = function(top, left, isRefresh) {
  ...
  Form = (function(_super) {
    ...
    Form.prototype.events = {
      ...
      "mousedown .addTaskHead": function(e) {
        var _ref;
        return _ref = [true, e.clientX, e.clientY], this.isMove = _ref[0], this.preLeft = _ref[1], this.preTop = _ref[2], _ref;
      },
      "mouseup .addTaskHead": function(e) {
        return [this.isMove = false, this.el.css("opacity", 1)];
      },
      "mousemove .addTaskHead": function(e) {
        var dx, dy;
        if (!this.isMove) {
          return;
        }
    ...
    Form.prototype.postTask = function(e) {
      ...
      if (this.taskId.val()) {
        tk = this.task;
        tk.one("ajaxSuccess", (function(_this) {
    ...
    Form.prototype.render = function(task) {
      ...
      if (task.Name) {
        ...
        task.Param = [];
        task.JobList = this.item.Jobs;
        task.JobName = this.item.Jobs[this.item.Jobs.length - 1].Name;
        task.JobId = this.item.Jobs[this.item.Jobs.length - 1].Id;
        task.JobNo = this.item.Jobs.length - 1;
        task.RgbColor = Style.getRgbColor();
      }
  ...
  Shape = (function(_super) {
    ...
    Shape.prototype.refreshTaskList = function(top) {
      var i, j, jb, job, k, key, left, rts, s, spacing, t, task, tasks, tk, v, value, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _results;
      if (top == null) {
        top = 100;
      }
      if (this.taskList) {
      ...
      for (i = _j = 0, _len1 = _ref1.length; _j < _len1; i = ++_j) {
        ...
        for (j = _k = 0, _len2 = tasks.length; _k < _len2; j = ++_k) {
          task = tasks[j];
          tk = new Task();
          for (key in task) {
            value = task[key];
          ...
          _ref2 = this.getTaskShape(t.RelTaskId);
    ...
    Shape.prototype.updateTaskAndRefresh = function(task, status, xhr) {
      ...
      if (xhr === "success") {
        ...
        tp.task = task;
        tp.text.remove();
        tp.text = this.paper.text(tp.sp.ox, tp.sp.oy, tp.task.Name);
        tp.text.toBack();
        tp.text.attr({
          fill: "#333",
          stroke: "none",
        ...
        return tp.sp.animate(s);
      }
    };

    Shape.prototype.addTaskAndRefresh = function(task, status, xhr) {
      var ci, el, i, j, key, t, tk, value, _i, _j, _len, _len1, _ref, _ref1;
      if (xhr === "success") {
        tk = new Task();
        for (key in task) {
          value = task[key];
    ...
    function App() {
      ...
      this.nv.bind('refreshAllTask', (function(_this) {
        return function() {
          ...
          Schedule.bind("findRecord", function(rs) {
            _this.main.mainInfo.paper;
            _this.main.mainInfo.draw(rs);
            return _this.main.mainInfo.taskShape.refreshTaskList();
          });
          return _this.main;
        };
      })(this));
      this.routes({
        '': function(params) {
          this.main.mainList.active(params);
        ...
        '/schedules/:id': (function(_this) {
          return function(params) {
            _this.main.mainInfo.active(params);
  ...
  Schedule = (function(_super) {
    ...
    function Schedule() {
      this.SplitName = __bind(this.SplitName, this);
      Moment.lang('zh-cn');
      Schedule.__super__.constructor.apply(this, arguments);
    }

    Schedule.prototype.GetNextStart = function() {
      return Moment(this.NextStart).calendar();
    };

    Schedule.prototype.GetCycStyle = function() {
      switch (this.Cyc) {
        case "ss":
    ...
    Schedule.prototype.SplitName = function(len) {
      var i, s, si, sname, _i, _len;
      s = this.Name.split("");
      sname = "";
      for (i = _i = 0, _len = s.length; _i < _len; i = ++_i) {
        si = s[i];
        sname += si;
        if (i > 0 && __modulo(i, len) === 0) {
          sname += "\n";
        }
      }
      return sname;
    ...
    Schedule.prototype.GetSecond = function() {
      ...
      for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
        t = _ref[i];
        startMonth = this.StartMonth[i] === 0 ? 1 : this.StartMonth[i];
        t = t / 1000 / 1000 / 1000;
        s = {
        ...
        switch (cyc) {
          ...
          case "mi":
            ...
            if ((_ref1 = this.Cyc) === 'ss' || _ref1 === 'mi') {
              _results.push(sc = "！！！" + sc + s['mi'] + "分" + s['ss'] + "秒");
            } else {
              _results.push(sc = "" + sc + s['mi'] + "分" + s['ss'] + "秒");
            }
            break;
          case "h":
            ...
            if ((_ref2 = this.Cyc) === 'ss' || _ref2 === 'mi' || _ref2 === 'h') {
              _results.push(sc = "！！！" + sc + s['h'] + "点" + s['mi'] + "分" + s['ss'] + "秒");
            } else {
              _results.push(sc = "" + sc + s['h'] + "点" + s['mi'] + "分" + s['ss'] + "秒");
            }
            break;
          case "d":
            ...
            if ((_ref3 = this.Cyc) === 'ss' || _ref3 === 'mi' || _ref3 === 'h' || _ref3 === 'd') {
              _results.push(sc = "！！！" + sc + s['d'] + "日" + s['h'] + "点" + s['mi'] + "分" + s['ss'] + "秒");
            } else {
              _results.push(sc = "" + sc + s['d'] + "日" + s['h'] + "点" + s['mi'] + "分" + s['ss'] + "秒");
            }
            break;
...
module.exports = content;}, "views/main-list": function(exports, require, module) {var content = function(__obj) {
  ...
  (function() {
    (function() {
      var gcyc, gnext, gs, gstyle, ssd, _i, _len;
      ...
      if (this.Name.length > 7) {
        __out.push('\n                    ');
        __out.push(__sanitize(this.Name.substr(0, 7)));
        __out.push('...\n                ');
      } else {
        __out.push('\n                    ');
        __out.push(__sanitize(this.Name));
      ...
      __out.push('\n            </span>\n            <!-- 周期 -->\n            <span class="cyc pull-right label ');
...
module.exports = content;}, "views/navbar": function(exports, require, module) {var content = function(__obj) {
  ...
  (function() {
    (function() {
      __out.push('<header id="header" >\n    <h1 id="home">\n        <span class="glyphicon glyphicon-home" ></span>&nbsp;\n    </h1>\n    &nbsp;\n\n    <h1 id="addSchedule">\n        <span class="addStart glyphicon glyphicon-plus" ></span>&nbsp;S\n    </h1>\n    &nbsp;\n\n    <h1 id="addTask">\n        <span class="addStart glyphicon glyphicon-plus" ></span>&nbsp;T\n    </h1>\n    &nbsp;\n\n    <h1 id="refreshAll" >\n        <span class="addStart glyphicon glyphicon-refresh" ></span>\n    </h1>\n     \n    <input id="isearch" type="text" class="sinput" placeholder="搜索..." value=""/>\n\n</header>\n\n\n');
...
module.exports = content;}, "views/task": function(exports, require, module) {var content = function(__obj) {
  ...
  (function() {
    (function() {
      ...
      __out.push('"/>\n        <br>\n\n        <div class="btn-group">\n            <button type="button" class="jobbtn btn dropdown-toggle" style="background-color: ');
