...
module.exports = jQuery;}, "momentify/index": function(exports, require, module) {// moment.js
// version : 2.1.0
// author : Tim Wood
// license : MIT
// momentjs.com
...
}, "raphael/node_modules/eve/eve": function(exports, require, module) {// Copyright (c) 2013 Adobe Systems Incorporated. All rights reserved.
// 
...
}, "raphael/raphael.svg": function(exports, require, module) {// ┌─────────────────────────────────────────────────────────────────────┐ \\
...
(function (glob) {
  ...
  ScheduleInfo = (function(_super) {
    ...
    function ScheduleInfo() {
      ...
      Schedule.bind("refresh", this.getData);
      this.active(this.change);
    }

    ScheduleInfo.prototype.getData = function() {
      return console.log(Schedule.find({
        id: 1
      }));
    };
    ...
    ScheduleInfo.prototype.change = function(params) {
      ...
      this.item = Schedule.find(params.id);
      return this.render(this.item);
    };

    ScheduleInfo.prototype.render = function(item) {
      if (item) {
        this.item = item;
      }
      this.html(this.template(this.item));
    ...
    ScheduleInfo.prototype.template = function(items) {
      return require('views/schedule-show-info')(items);
    };

    ScheduleInfo.prototype.draw = function() {
      var color, paper, ts, ts1, ts2, ts3, ts4, ts5, ts6, ts7;
  ...
  TaskSymbol = (function() {
    function TaskSymbol(paper, cx, cy, name, color) {
      var an, st;
      this.paper = paper;
      this.cx = cx;
      this.cy = cy;
      ...
      this.nextRel = [];
      this.paper.setStart();
      this.sp = this.paper.circle(this.cx, this.cy, 30);
      this.sp.ts = this;
      this.sp.cx = this.cx;
      this.sp.cy = this.cy;
      this.sp.attr({
  ...
  App = (function(_super) {
    ...
    function App() {
      ...
      Schedule.bind("ajaxSuccess", function(status, xhr) {
...
}, "lib/bindings": function(exports, require, module) {(function() {
...
}, "lib/local": function(exports, require, module) {(function() {
  var Spine;
...
}, "lib/manager": function(exports, require, module) {(function() {
  var $, Spine,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    __slice = [].slice,
...
}, "lib/relation": function(exports, require, module) {(function() {
...
}, "lib/route": function(exports, require, module) {(function() {
...
}, "lib/spine": function(exports, require, module) {
/*
...
}, "views/schedule-show-info": function(exports, require, module) {var content = function(__obj) {
  if (!__obj) __obj = {};
